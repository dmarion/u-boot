...
extern unsigned int NandSizeInByteShift, NandBlockSizeInByteShift, NandPageSizeInByteShift;
extern unsigned int NandOobSize;
extern unsigned int NandEccBit;
#define NandBlockSizeInByte (1<<NandBlockSizeInByteShift)
#define NandPageSizeInByte  (1<<NandPageSizeInByteShift)

unsigned int NandIsMlc1(void);
unsigned int NandIsMlc2(void);
unsigned int NandIsMlc(void);
